...
export const CITY_REGION_MAP: Record<string, Region> = {
  // גוש דן ותל אביב
  "תל אביב": "גוש דן ותל אביב",
  "תל-אביב": "גוש דן ותל אביב",
  "בת ים": "גוש דן ותל אביב",
  "חולון": "גוש דן ותל אביב",
  "רמת גן": "גוש דן ותל אביב",
  "גבעתיים": "גוש דן ותל אביב",
  "בני ברק": "גוש דן ותל אביב",
  "פתח תקווה": "גוש דן ותל אביב",
  "קריית אונו": "גוש דן ותל אביב",
  "אור יהודה": "גוש דן ותל אביב",
  "אזור": "גוש דן ותל אביב",
  "יהוד": "גוש דן ותל אביב",
  "גני תקווה": "גוש דן ותל אביב",
  // מרכז
  "ראשון לציון": "מרכז",
  "רחובות": "מרכז",
  "לוד": "מרכז",
  ...
  "קריית טבעון": "חיפה והקריות",
  "נשר": "חיפה והקריות",
  "טירת כרמל": "חיפה והקריות",
  "חדרה": "חיפה והקריות",
  "זכרון יעקב": "חיפה והקריות",
  "פרדס חנה": "חיפה והקריות",
  "עכו": "חיפה והקריות",
  // צפון
  "נהריה": "צפון",
  "כרמיאל": "צפון",
  ...
  "אפולה": "עמקים וגליל",
  // באר שבע והנגב
  "באר שבע": "באר שבע והנגב",
  "דימונה": "באר שבע והנגב",
  "ערד": "באר שבע והנגב",
  "מצפה רמון": "באר שבע והנגב",
  // דרום
  "נתיבות": "דרום",
  "אופקים": "דרום",
  "שדרות": "דרום",
